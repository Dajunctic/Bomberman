...
- *Bomb* là đối tượng mà Bomber sẽ đặt tại các ô Floor. Khi đã được kích hoạt, Bomber và Enemy không thể di chuyển vào vị trí Bomb. Tuy nhiên ngay khi Bomber vừa đặt và kích hoạt Bomb tại ví trí của mình, Bomber có một lần được đi từ vị trí đặt Bomb ra vị trí bên cạnh. Sau khi kích hoạt, Bomb sẽ tự nổ, các đối tượng *Flame*  được tạo ra.

- *Floor* là các ô đối tượng có thể đi qua và đặt bomb.
...
- ![](src/main/resources/introduce/horizontal_up.png) *Fence* là những cổng màn chơi. Khi tất cả kẻ địch trong màn bị tiêu diệt thì cổng sẽ mở ra và nhân vật có thể di chuyển qua.
...
- Và các loại buff khác giúp tăng sát thương các kĩ năng.


Có nhiều loại Enemy trong Bomberman, tuy nhiên trong phiên bản này chỉ cài đặt 5 loại enemy sau:

- ![](src/main/resources/introduce/enemy.png)*Balloom* là Enemy đơn giản nhất, di chuyển ngẫu nhiên với vận tốc cố định.

- *Suicider* có di chuyển ngẫu nhiên với tốc độ nhanh hơn Balloom và khi phát hiện nhân vật thì lao đến và tự tử tạo vụ nổ xung quanh.

- *Ghost* có di chuyển ngẫu nhiên với tốc độ nhanh hơn Balloom và bạn không thể nhìn thấy chúng trong map lớn buộc phải bật Enemy map lên.

- *Jumper* là Enemy di chuyển "thông minh" hơn so với Balloom, di chuyển qua tường và nó sẽ nhảy thẳng tới để cắn bạn khi bạn ở trong tầm nhìn của nó.

- ![](src/main/resources/introduce/mage.png) *Mage* là Enemy đặc biệt nhất, nó sẽ dùng gậy và dùng kĩ năng của nó tới bạn và tạo ra lửa màu xanh xanh thiêu đốt bạn hoặc triệu hồi các con Suicider. Khi Mage chết sẽ tạo ra 4 con Suicider.
